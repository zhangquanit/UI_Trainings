...
public class BarTabDemoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);   //是否显示标题栏左上角的图标
...
//        mTabLayout.setSelectedTabIndicatorHeight(20);//tab下划线高度
//        mTabLayout.setSelectedTabIndicatorColor(Color.GREEN);//tab下划线颜色
//        mTabLayout.setTabTextColors(Color.RED); //tab文字颜色
        mTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            @Override
            public void onTabSelected(TabLayout.Tab tab) {
                System.out.println("onTabSelected=" + tab);
            }

            @Override
            public void onTabUnselected(TabLayout.Tab tab) {
                System.out.println("onTabUnselected=" + tab);
            }

            @Override
            public void onTabReselected(TabLayout.Tab tab) {
                System.out.println("onTabReselected=" + tab);
            }
        });
